...
for crossover_method, mutation_method, survivor_strategy in product(crossover_methods, mutation_methods, survivor_strategies):
    print(f"Testing combination: Crossover = {crossover_method}, Mutation = {mutation_method}, Survivor Strategy = {survivor_strategy}")
...
for result in results:
    label = f"{result['crossover_method']} + {result['mutation_method']} + {result['survivor_strategy']}"

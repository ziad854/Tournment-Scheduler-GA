...
from src.utils.analsyis import sort_schedule  # Ensure this is defined or imported



if __name__ == "__main__":
    # Load input data
    constraints = parse_input_data("D:\\Education\\level 3\\Second Term\\Projects\\EA\\Tournment-Scheduler-GA\\data\\data.json")

    # Run GA
    best_schedule, best_fitness = genetic_algorithm(constraints, population_size=150, generations_size=500)
